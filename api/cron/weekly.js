...
function signalEtikett(typ) { return { jobbannons:'Jobbannons', finance_hiring:'Finance hiring', management_change:'Ledningsförändring', growth:'Tillväxt', expansion:'Expansion', restructuring:'Omstrukturering', layoffs:'Varsel/uppsägningar', new_hires:'Nyrekrytering', acquisition:'Förvärv/fusion', funding:'Finansiering/investering', ownership_change:'Ägarförändring', annual_report:'Årsredovisning', financial_pressure:'Finansiell press', balance_sheet_change:'Balansräkningsförändring', profitability_change:'Resultat/P&L-förändring', system_change:'System/ERP-förändring', audit_remark:'Revisionsanmärkning', ny_cfo:'Ny CFO', ny_vd:'Ny VD', ny_ledning:'Ny ledning', 'forvärv':'Förvärv', varsel:'Varsel', nyhet:'Nyhet', arsredovisning:'Årsredovisning', manuell:'Manuell' }[typ] || typ; }
